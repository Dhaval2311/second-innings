...
async def generate_linkedin_dm(
    ...
    prompt = (
        ...
        f"- STRICT hard limit: UNDER {_LINKEDIN_CHAR_LIMIT} characters total (count spaces too).\n"
        "- 3 short sentences only:\n"
        f"  1. Who you are: name, years, and 1-2 specific skills.\n"
        f"  2. Why {company} / the {role} role specifically — one concrete observation, not generic.\n"
        "  3. Soft CTA: 'Open to a quick chat?' or similar.\n"
        "- Tone: peer-to-peer, warm, real. NOT a cover letter opener. NOT salesy.\n"
        "- Forbidden phrases: 'I hope this finds you', 'I am writing to', 'I am excited', 'synergy'.\n"
        "- Output the message ONLY — no subject line, no labels, no quotes.\n\n"
        "LinkedIn DM:"
    )
